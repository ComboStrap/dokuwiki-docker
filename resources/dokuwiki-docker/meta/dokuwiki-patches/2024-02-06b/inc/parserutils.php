    ...
    if ($evt->advise_before()) {
        ...
        foreach ($instructions as $instruction) {
            ...
            try {
                ...
                // https://github.com/dokuwiki/dokuwiki/issues/3783#issuecomment-2293035384
                // The error could be caught with the TypeError exception
                // but why stop and caught all errors
            }
        }
